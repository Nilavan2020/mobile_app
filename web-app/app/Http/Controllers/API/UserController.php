...
class UserController extends Controller
{
    ...
    public function getProfile(Request $request)
    {
        ...
        $user = MobileUser::select('full_name', 'email', 'phone_number', 'gender', 'dob', 'emergency_contact', 'police_contact')
            ->where('id', $userId)
            ->first();
    ...
    public function updateEmergencyContacts(Request $request)
    {
        ...
        $user->police_contact = $request->police_contact;
        $user->save();
        ...
        return response()->json([
            ...
            'data' => [
                ...
                'police_contact' => $user->police_contact,
            ]
        ]);
    }
