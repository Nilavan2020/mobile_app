...
<head>
    ...
    <meta content="Smart Safety Welfare App - Management System" name="description" />
    <meta content="Smart Safety Welfare" name="author" />
            ...
            <div class="slimscroll-menu" id="remove-scroll">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li>
                            <a href="{{ route('relief.requests') }}" class="waves-effect">
                                <i class="fa fa-hand-paper"></i> <span> Relief Requests </span>
                            </a>
                        </li>

                        <li>
                            <a href="{{ route('relief.donations') }}" class="waves-effect">
                                <i class="fa fa-heart"></i> <span> Relief Donations </span>
                            </a>
                        </li>

                        <li>
                            <a href="{{ route('sos.alerts') }}" class="waves-effect">
                                <i class="fa fa-exclamation-triangle"></i> <span> SOS Alerts </span>
                                @php
                                    $sosAlertCount = \App\Models\SOSAlert::where('sms_sent', true)->count();
                                @endphp
                                @if($sosAlertCount > 0)
                                    <span class="badge badge-danger badge-pill float-right">{{ $sosAlertCount }}</span>
                                @endif
                            </a>
                        </li>

                        <li>
                            <a href="{{ route('face.sessions.index') }}" class="waves-effect">
                                <i class="mdi mdi-face-recognition"></i> <span> Camera Sessions </span>
                            </a>
                        </li>
